...
WebUI.setText(findTestObject('Object Repository/Record/input_Username_username'), 'asdjksdajj')

WebUI.setEncryptedText(findTestObject('Object Repository/Record/input_Password_password'), 'lp+L6Zv8NRRWKHXFzFsImA==')
